...
#define WIDTH	1024
#define HEIGHT	1024
#define NUM_BODIES (1024*256)
#define PI      3.14159265358979323846
#define TO_METERS 1.496e11 // Meters in an AU
#define DOT_SIZE 6 // 15  // Range of pixels to render
#define SYSTEM_SIZE 3.5    // Farthest particles in AU
#define SYSTEM_THICKNESS 0.12  // 0.05  Thickness in AU
...
#define EXTRA_MASS 5.0 //0.02 Portion of solar mass
...
#define RENDER_SCALE 3.5 //1.1
#define MAX_VEL_COLOR 40000.0  // Both in km/s
#define MIN_VEL_COLOR 14000.0
#define PARTICLE_BRIGHTNESS 0.12//0.03 for 256/512k, 0.4 for 16k
