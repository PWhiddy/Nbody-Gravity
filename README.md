...
Includes a renderer that produces high quailty PPM images of each step of the simulation. These can be compiled into animations with ffmpeg. [Example](https://goo.gl/uUEgHl)
